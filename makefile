...
$(BUILD_DIR)/WeaponFactory.o: $(BUILD_DIR) $(BUILD_DIR)/CommonSword.o $(BUILD_DIR)/CommonSpear.o $(BUILD_DIR)/CrazyRandomSword.o $(BUILD_DIR)/SimpleAxe.o $(BUILD_DIR)/MagicWand.o WeaponFactory.cpp WeaponFactory.h
...
$(BUILD_DIR)/MagicWand.o: $(BUILD_DIR) $(BUILD_DIR)/Weapon.o MagicWand.cpp MagicWand.h
	$(CXX) $(CXXFLAGS) -c -o $@ MagicWand.cpp
